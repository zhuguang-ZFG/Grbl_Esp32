...
/*
  grbl_limits.h - code pertaining to limit-switches and performing the homing cycle
  Part of Grbl
...
/*
  2026-09-06 hutuji 修复：371a3c4 删除残留的 src/Limits.h 时把本文件承载的
  全部声明一并删掉了（commit message 称 "zero includers" 失实——Grbl.h 仍在
  include，MotionControl/Protocol/Report/Limits.cpp 在生产宏
  HOMING_SINGLE_AXIS_COMMANDS/CHECK_LIMITS_AT_INIT/REPORT_FIELD_PIN_STATE 下
  无条件使用这些符号），固件构建因此断。按上游 2018 年的改名方案以
  grbl_limits.h 文件名复活（避开与 C 库 limits.h 经 -iquote include_next
  的遮蔽——那是当初删除的正当动机，文件名保留原改名即两全）。
*/
