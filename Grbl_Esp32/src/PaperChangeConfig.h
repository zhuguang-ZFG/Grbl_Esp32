...
#define PAPER_EJECT_PROGRESS_STEP_INTERVAL                1000  // EJECTING阶段进度日志间隔
#define PAPER_REPOSITION_REVERSE_PROGRESS_STEP_INTERVAL   200   // REPOSITION反转阶段进度日志间隔
#define PAPER_REPOSITION_FORWARD_PROGRESS_STEP_INTERVAL   50    // REPOSITION正转阶段进度日志间隔
