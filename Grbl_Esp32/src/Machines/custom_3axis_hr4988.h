...
// 面板电机：最终微调到位的步数
#define PANEL_FINAL_STEPS     350u  // Step8 最终对位步数（HIL 调参：320→350）
...
// 可用 -DCLAMP_TOGGLE_STEPS=100u 覆盖（见 env:release_clamp160 / release_clamp100）
#ifndef CLAMP_TOGGLE_STEPS
