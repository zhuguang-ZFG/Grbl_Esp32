...
#ifndef DISABLE_BLUETOOTH  // -DDISABLE_BLUETOOTH: QEMU/SIL builds (esp_bt_controller_init asserts under qemu-system-xtensa)
...
#define BLOCK_BUFFER_SIZE 250 // 从200增大到250，进一步增加planner缓冲区深度，容忍更长的蓝牙延迟
...
#define SEGMENT_BUFFER_SIZE 48 // 步段缓冲：缓解上位机不可改时的 BT 断流/块间空档（发抖）
