...
// Probe protection optionally monitors the probe for contact when the probe cycle is not running.
// This can stop motion to prevent damaging the probe when it is accidentally crashed into something.
